...
# the '!'-prefixed short codes become not_ prefixed, SNMP safe names
is( $lilith->{snmp_class_map}{ lc('Unsuccessful User Privilege Gain') },
	'not_SucUsrPG', 'negated short codes are not_ prefixed in snmp_class_map' );
