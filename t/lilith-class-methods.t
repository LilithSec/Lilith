...
# unknown class returns 'unknownC'
is( $lilith->get_short_class_snmp('NoSuchClass'),
	'unknownC', 'get_short_class_snmp with unknown class returns "unknownC"' );
...
is( $lilith->get_short_class_snmp('Attempted Information Leak'),
	'not_IL', 'get_short_class_snmp: Attempted Information Leak' );
