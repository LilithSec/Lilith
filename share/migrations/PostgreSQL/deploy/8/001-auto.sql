...
-- (id/x/y/w/h) the Gridstack UI serializes. The web UI is unauthenticated, so
-- boards are global rather than per-user; the 'default' board is created here
-- and flagged is_default.
